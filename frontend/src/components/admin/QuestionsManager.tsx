...
export const QuestionsManager = () => {
  const [questionList, setQuestionList] = useState(problems);
  ...
  const handleSaveQuestion = (isNew: boolean) => {
    if (isNew) {
      setQuestionList([...questionList, currentQuestion]);
      setIsAddDialogOpen(false);
    } else {
      setQuestionList(questionList.map(q => q.id === currentQuestion.id ? currentQuestion : q));
      setIsEditDialogOpen(false);
    }
    
    toast({
      title: isNew ? "Question added" : "Question updated",
      description: `The question has been successfully ${isNew ? 'added' : 'updated'}.`,
    });
  };
  ...
  return (
    ...
    >
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-xl font-semibold text-leetcode-text-primary">Manage Questions</h2>
        <Button onClick={handleAddQuestion} className="bg-leetcode-green hover:bg-leetcode-green/90">
      ...
      <Card className="bg-leetcode-bg-dark border-leetcode-bg-light overflow-hidden">
        <div className="overflow-x-auto">
          <Table>
            <TableHeader>
              <TableRow>
                <TableHead className="text-leetcode-text-secondary">ID</TableHead>
                <TableHead className="text-leetcode-text-secondary">Title</TableHead>
                <TableHead className="text-leetcode-text-secondary">Difficulty</TableHead>
                <TableHead className="text-leetcode-text-secondary">Examples</TableHead>
                <TableHead className="text-leetcode-text-secondary">Actions</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {questionList.map((question) => (
                <TableRow key={question.id} className="border-leetcode-bg-light">
                  <TableCell className="text-leetcode-text-primary">{question.id}</TableCell>
                  <TableCell className="text-leetcode-text-primary font-medium">{question.title}</TableCell>
                  <TableCell>
                    <span className={`px-2 py-1 rounded text-xs font-medium ${
                      question.difficulty === 'Easy' ? 'bg-leetcode-green/20 text-leetcode-green' :
                  ...
                  <TableCell className="text-leetcode-text-primary">{question.examples.length}</TableCell>
                  <TableCell>
                    <div className="flex space-x-2">
                      ...
                      <Button variant="outline" size="sm" className="text-leetcode-red border-leetcode-red hover:bg-leetcode-red/10" onClick={() => handleDeleteQuestion(question.id)}>
      ...
      <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
        <DialogContent className="bg-leetcode-bg-medium border-leetcode-bg-light text-leetcode-text-primary max-w-3xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="text-leetcode-text-primary">Add New Question</DialogTitle>
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid grid-cols-4 items-start gap-4">
              ...
              <div className="col-span-3">
                <Textarea 
                  value={currentQuestion?.starterCode || '// Write your code here'}
            ...
            <div className="grid grid-cols-4 items-start gap-4">
              <div className="text-right pt-2">
                ...
                <p className="text-xs text-leetcode-text-secondary mt-1">Add input/output examples</p>
              </div>
              <div className="col-span-3 space-y-4">
                {currentQuestion?.examples.map((example: any, index: number) => (
                  <Card key={index} className="bg-leetcode-bg-dark border-leetcode-bg-light">
                    <CardHeader className="py-3 px-4">
                      <div className="flex justify-between items-center">
                        <CardTitle className="text-sm text-leetcode-text-primary">Example {index + 1}</CardTitle>
                        <Button 
                          variant="ghost" 
                          size="sm"
                    ...
                    <CardContent className="py-2 px-4 space-y-2">
                      <div className="grid grid-cols-3 gap-2">
                        ...
                        <div>
                          <Label htmlFor={`output-${index}`} className="text-xs">Output</Label>
                          <Input 
                            id={`output-${index}`}
                        ...
                        <div>
                          <Label htmlFor={`explanation-${index}`} className="text-xs">Explanation</Label>
                          <Input 
                ...
                <Card className="bg-leetcode-bg-dark border-leetcode-bg-light border-dashed">
                  <CardHeader className="py-3 px-4">
                    <CardTitle className="text-sm text-leetcode-text-primary">Add New Example</CardTitle>
                  </CardHeader>
                  <CardContent className="py-2 px-4 space-y-2">
                    <div className="grid grid-cols-3 gap-2">
                      <div>
                        <Label htmlFor="new-input" className="text-xs">Input</Label>
                        <Input 
                          id="new-input"
                      ...
                      <div>
                        <Label htmlFor="new-output" className="text-xs">Output</Label>
                        <Input 
                          id="new-output"
                      ...
                      <div>
                        <Label htmlFor="new-explanation" className="text-xs">Explanation (Optional)</Label>
                        <Input 
                          id="new-explanation"
            ...
            <div className="grid grid-cols-4 items-start gap-4">
              <div className="text-right pt-2">
                ...
                <p className="text-xs text-leetcode-text-secondary mt-1">Add problem constraints</p>
              </div>
          ...
          <DialogFooter>
            <Button variant="outline" onClick={() => setIsAddDialogOpen(false)} className="border-leetcode-bg-light text-leetcode-text-secondary">
              Cancel
            </Button>
            <Button onClick={() => handleSaveQuestion(true)} className="bg-leetcode-green hover:bg-leetcode-green/90">
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent className="bg-leetcode-bg-medium border-leetcode-bg-light text-leetcode-text-primary max-w-3xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="text-leetcode-text-primary">Edit Question</DialogTitle>
            <DialogDescription className="text-leetcode-text-secondary">
              ...
              <div className="col-span-3 space-y-4">
                {currentQuestion?.examples.map((example: any, index: number) => (
                  <Card key={index} className="bg-leetcode-bg-dark border-leetcode-bg-light">
                    ...
                    <CardContent className="py-2 px-4 space-y-2">
                      <div className="grid grid-cols-3 gap-2">
                        <div>
                          <Label htmlFor={`edit-input-${index}`} className="text-xs">Input</Label>
                          <Input 
                            id={`edit-input-${index}`}
                            value={example.input} 
                            readOnly
                        ...
                        <div>
                          <Label htmlFor={`edit-output-${index}`} className="text-xs">Output</Label>
                          <Input 
                        ...
                        <div>
                          <Label htmlFor={`edit-explanation-${index}`} className="text-xs">Explanation</Label>
                          <Input 
                ...
                <Card className="bg-leetcode-bg-dark border-leetcode-bg-light border-dashed">
                  ...
                  <CardContent className="py-2 px-4 space-y-2">
                    <div className="grid grid-cols-3 gap-2">
                      <div>
                        <Label htmlFor="edit-new-input" className="text-xs">Input</Label>
                        <Input 
                          id="edit-new-input"
                          value={newExample.input} 
                          onChange={(e) => setNewExample({...newExample, input: e.target.value})}
                      ...
                      <div>
                        <Label htmlFor="edit-new-output" className="text-xs">Output</Label>
                        <Input 
                          id="edit-new-output"
                          value={newExample.output} 
                          onChange={(e) => setNewExample({...newExample, output: e.target.value})}
                      ...
                      <div>
                        <Label htmlFor="edit-new-explanation" className="text-xs">Explanation (Optional)</Label>
                        <Input 
          ...
          <DialogFooter>
            <Button variant="outline" onClick={() => setIsEditDialogOpen(false)} className="border-leetcode-bg-light text-leetcode-text-secondary">
              Cancel
            </Button>
            <Button onClick={() => handleSaveQuestion(false)} className="bg-leetcode-green hover:bg-leetcode-green/90">
              <Save className="h-4 w-4 mr-2" />
              Update Question
            </Button>
          </DialogFooter>
